const sacs = [
  {
    ...
    description:
      "Ce magnifique sac sera un cadeau que vous pourrez offrir messieurs à n'importe quelle occassion !",
    price: 105,
    promo: false,
    pricePromo: 99,
  },
  {
    ...
    description:
      "Ce sac a été fait totalement à la main, il est en pur cuir !!!",
    price: 200,
    promo: true,
    pricePromo: 180,
  },
  {
    ...
    description:
      "Ce sac bleu est un plaisir pour les yeux, un toucher doux, allez-y, foncé !!!",
    price: 99,
    promo: false,
    pricePromo: 85,
  },
  {
    ...
    description:
      "Ce petit sac enchantera madame, un anniversaire, une fête, elle craquera !!!",
    price: 55,
    promo: true,
    pricePromo: 40,
  },
...
sacs.forEach((element, index) => {
  ...
  infos.append(title, description, price);

  product.append(imageParent, infos);
